...
class GitHubDataBuilder:
    ...
    def with_labels(self, count: int = 2, custom_labels: Optional[List[Dict[str, Any]]] = None) -> "GitHubDataBuilder":
            ...
            if count > len(default_labels):
                for i in range(len(default_labels), count):
                    generated_label = {
                        ...
                        "url": f"https://api.github.com/repos/owner/repo/labels/label-{i + 1}",
    ...
    def with_issues(self, count: int = 3, include_closed: bool = False, custom_issues: Optional[List[Dict[str, Any]]] = None) -> "GitHubDataBuilder":
        ...
        if custom_issues:
            ...
            for i in range(count):
                ...
                issue = {
                    ...
                    "body": f"This is test issue {issue_number}" if i % 2 == 0 else None,
                    ...
                    "closed_at": f"2023-01-{min(10 + i, 31):02d}T16:00:00Z" if is_closed else None,
    ...
    def with_comments(self, issue_count: int = 2, comments_per_issue: int = 1, custom_comments: Optional[List[Dict[str, Any]]] = None) -> "GitHubDataBuilder":
            ...
            for i in range(issue_count):
                ...
                for j in range(comments_per_issue):
                    comment = {
                        ...
                        "created_at": f"2023-01-{min(10 + i, 31):02d}T{min(12 + j, 23):02d}:00:00Z",
                        "updated_at": f"2023-01-{min(10 + i, 31):02d}T{min(12 + j, 23):02d}:00:00Z",
    ...
    def with_pull_requests(self, count: int = 2, custom_prs: Optional[List[Dict[str, Any]]] = None) -> "GitHubDataBuilder":
        ...
        if custom_prs:
            ...
            for i in range(count):
                ...
                pr = {
                    ...
                    "closed_at": f"2023-01-{min(15 + i, 31):02d}T15:00:00Z" if is_merged else None,
                    "merged_at": f"2023-01-{min(15 + i, 31):02d}T15:00:00Z" if is_merged else None,
    ...
    def with_pr_comments(self, pr_count: int = 2, comments_per_pr: int = 1, custom_pr_comments: Optional[List[Dict[str, Any]]] = None) -> "GitHubDataBuilder":
                ...
                for j in range(comments_per_pr):
                    comment = {
                        ...
                        "user": {
                            ...
                            "id": self._user_id_counter + j,
                            "avatar_url": f"https://github.com/prcommenter{j + 1}.png",
                            "html_url": f"https://github.com/prcommenter{j + 1}",
                        },
                        "created_at": f"2023-01-{min(15 + i, 31):02d}T{min(13 + j, 23):02d}:00:00Z",
                        "updated_at": f"2023-01-{min(15 + i, 31):02d}T{min(13 + j, 23):02d}:00:00Z",
    ...
    def with_unicode_content(self) -> "GitHubDataBuilder":
        ...
        unicode_comment = {
            ...
            "html_url": f"https://github.com/owner/repo/issues/999#issuecomment-{self._comment_id_counter}",
