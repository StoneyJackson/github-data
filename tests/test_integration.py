...
class TestSaveRestoreIntegration:
    ...
    def test_save_creates_json_files_with_correct_structure(self, mock_boundary_class, temp_data_dir, sample_github_data):
    ...
    @patch('src.github.service.GitHubApiBoundary')
    def test_restore_recreates_data_from_json_files(self, mock_boundary_class, temp_data_dir, sample_github_data):
    ...
    @patch('src.github.service.GitHubApiBoundary')
    def test_complete_save_restore_cycle_preserves_data_integrity(self, mock_boundary_class, temp_data_dir, sample_github_data):
        ...
        save_boundary.get_all_issue_comments.return_value = sample_github_data["comments"]
    ...
    def test_restore_fails_when_json_files_missing(self, temp_data_dir):
        """Test that restore operation fails gracefully when required files are missing."""
    ...
    @patch('src.github.service.GitHubApiBoundary') 
    def test_save_creates_output_directory_if_missing(self, mock_boundary_class, temp_data_dir):
...
class TestErrorHandlingIntegration:
    ...
    @patch('src.github.service.GitHubApiBoundary')
    def test_restore_handles_github_api_failures_gracefully(self, mock_boundary_class, temp_data_dir):
        """Test that restore continues despite GitHub API failures."""
        # Create test data files
        data_path = Path(temp_data_dir)
        
        test_labels = [
            {"name": "bug", "color": "ff0000", "description": "Bug label", "url": "http://example.com", "id": 1},
            {"name": "feature", "color": "00ff00", "description": "Feature label", "url": "http://example.com", "id": 2}
        ]
    ...
    @patch('src.github.service.GitHubApiBoundary')
    def test_data_type_conversion_and_validation(self, mock_boundary_class, temp_data_dir):
        ...
        assert isinstance(issues_data[0]["created_at"], str)  # Datetime serialized as string