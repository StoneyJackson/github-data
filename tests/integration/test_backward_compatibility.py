...
class TestBackwardCompatibility:
    ...
    def test_boolean_true_preserves_original_behavior(
        ...
        config = (
            ...
            .with_git_repo(False)
            .with_issues(True)  # Boolean True (Phase 1 behavior)
    ...
    def test_boolean_false_preserves_original_behavior(
        ...
        config = (
            ...
            .with_label_strategy("skip")
            .with_git_repo(False)
            .with_issues(False)  # Boolean False (Phase 1 behavior)
            .with_issue_comments(True)  # Should be ignored with warning
            .with_pull_requests(False)
            .with_pull_request_comments(False)
            .with_pr_reviews(False)
            .with_pr_review_comments(False)
    ...
    def test_pr_boolean_behavior_unchanged(
        ...
        config_true = (
            ...
            .with_token("test_token")
            .with_repo("owner/repo")
            .with_data_path(str(tmp_path / "true"))
            .with_label_strategy("skip")
            .with_git_repo(False)
            .with_issues(False)
            .with_issue_comments(False)
            .with_pull_requests(True)  # Boolean True (Phase 1 behavior)
        ...
        config_false = (
            ...
            .with_token("test_token")
            .with_repo("owner/repo")
            .with_data_path(str(tmp_path / "false"))
            .with_label_strategy("skip")
            .with_git_repo(False)
            .with_issues(False)
            .with_issue_comments(False)
            .with_pull_requests(False)  # Boolean False (Phase 1 behavior)
            .with_pull_request_comments(True)  # Should be ignored with warning
            .with_pr_reviews(False)
            .with_pr_review_comments(False)
            .with_sub_issues(False)
            .with_git_auth_method("token")
    ...
    def test_comment_coupling_backward_compatible(
        ...
        config = (
            ...
            .with_label_strategy("skip")
            .with_git_repo(False)
            .with_issues(True)  # Boolean True
            .with_issue_comments(True)  # Boolean True
            .with_pull_requests(True)  # Boolean True
            .with_pull_request_comments(True)  # Boolean True
            .with_pr_reviews(False)
            .with_pr_review_comments(False)
            .with_sub_issues(False)
            .with_git_auth_method("token")
    ...
    def test_mixed_boolean_selective_scenarios(
        ...
        config = (
            ...
            .with_label_strategy("skip")
            .with_git_repo(False)
            .with_issues(True)  # Boolean True (all issues)
            .with_issue_comments(True)
            .with_pull_requests({10})  # Selective (only PR 10)
            .with_pull_request_comments(True)
            .with_pr_reviews(False)
            .with_pr_review_comments(False)
            .with_sub_issues(False)
    ...
    def test_restore_boolean_behavior_preserved(
        ...
        restore_config = (
            ...
            .with_label_strategy("skip")
            .with_git_repo(False)
            .with_issues(True)  # Boolean True (restore all)
            .with_issue_comments(True)
            .with_pull_requests(True)  # Boolean True (restore all)
            .with_pull_request_comments(True)
            .with_pr_reviews(False)
            .with_pr_review_comments(False)
            .with_sub_issues(False)
    ...
    def test_validation_warnings_preserved(self, caplog):
        ...
        config = (
            ...
            .with_label_strategy("skip")
            .with_git_repo(False)
            .with_issues(False)  # Boolean False
            .with_issue_comments(True)  # Should trigger warning
            .with_pull_requests(False)
            .with_pull_request_comments(False)
            .with_pr_reviews(False)
            .with_pr_review_comments(False)
        ...
        config = (
            ...
            .with_issues(False)
            .with_issue_comments(False)
            .with_pull_requests(False)  # Boolean False
            .with_pull_request_comments(True)  # Should trigger warning
            .with_pr_reviews(False)
            .with_pr_review_comments(False)
            .with_sub_issues(False)
            .with_git_auth_method("token")
