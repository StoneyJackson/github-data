...
from src.main import get_env_var, main
...
class TestMain:
    ...
    @patch("src.main.get_env_var")
    @patch("builtins.print")
    def test_main_save_operation(self, mock_print, mock_get_env_var):
    ...
    @patch("src.main.get_env_var")
    @patch("builtins.print")
    def test_main_restore_operation(self, mock_print, mock_get_env_var):
    ...
    @patch("src.main.get_env_var")
    def test_main_invalid_operation_exits(self, mock_get_env_var):
