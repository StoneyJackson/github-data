...
class CommentsSaveStrategy(SaveEntityStrategy):
    ...
    def _filter_comments_by_issues(self, entities: List[Any], saved_issues: List[Any]) -> List[Any]:
        ...
        for issue in saved_issues:
            ...
            if hasattr(issue, 'html_url'):
                ...
                try:
                    ...
                    # Create API URL pattern: https://api.github.com/repos/owner/repo/issues/number
        ...
        if not saved_issue_identifiers:
            print("No valid issue identifiers found in saved issues, skipping all comments")
            return []
    ...
    def _comment_matches_issue(self, comment: Any, saved_issue_identifiers: set) -> bool:
