...
class GitHubClient:
    ...
    def _convert_issue_to_model(self, issue: PyGithubIssue) -> Issue:
        ...
        return Issue(
            ...
            assignees=[self._convert_user_to_model(assignee) for assignee in issue.assignees],
    ...
    def _convert_comments_to_models(self, comments: Iterator[PyGithubComment]) -> List[Comment]:
