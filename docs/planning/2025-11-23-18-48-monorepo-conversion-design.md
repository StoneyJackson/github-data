...
**Tasks:**
1. Merge `feat/monorepo-conversion` → `main`
2. Delete old code (everything outside packages/)
3. Tag release: `v2.0.0` (major version bump for breaking structure change)
